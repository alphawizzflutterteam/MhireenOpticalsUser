// final String appName = 'Magna Food Ex';
final String appName = 'Mahireen Opticals';

final String packageName = 'com.mahireenopticals.user';
final String androidLink = 'https://play.google.com/store/apps/details?id=';

final String iosPackage = 'com.mahireenopticals.user';
final String iosLink = 'your ios link here';
final String appStoreId = 'com.mahireenopticals.user';
...
final String baseUrl = 'https://developmentalphawizz.com/mahireen_opticals/app/v1/api/';
...
final String imageUrl = 'https://developmentalphawizz.com/mahireen_opticals/';

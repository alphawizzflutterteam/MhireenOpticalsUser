...
// import 'package:mahireenopticals/Screen/Seller_Details.dart';
...
import 'package:mahireenopticals/Helper/Session.dart';
import 'package:mahireenopticals/Model/Order_Model.dart';
import 'package:mahireenopticals/Screen/Dashboard.dart';
import 'package:mahireenopticals/Screen/Seller_Details.dart';
import 'package:file_picker/file_picker.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
        ...
        child: Padding(
            ...
            child: Column(
              children: [
                ...
                //   kojks
                orderItem.eyePrescriptionData == null
                    ? Container()
                    : SizedBox(height: 20),
                orderItem.eyePrescriptionData == null
                    ? Container()
                ...
                orderItem.eyePrescriptionData == null
                    ? Container()
                    : _buildEyeSection(
                        title: 'Left Side', isLeft: true, orderItem: orderItem),
                orderItem.eyePrescriptionData == null
                    ? Container()
                    : SizedBox(height: 20),
                Row(
...
//                     :SizedBox.shrink(),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 10),
            _buildEyeRow(isLeft: isLeft, orderItem: orderItem),
            // SizedBox(height: 10),
  ...
  Widget _buildEyeRow({required isLeft, required OrderItem orderItem}) {
    return Row(
      // mainAxisAlignment: MainAxisAlignment.spaceEvenly,
      children: [
        _buildSideBar(),
        _buildTextField(
            label: 'SPH', isHide: false, isLeft: isLeft, orderItem: orderItem),
        _buildTextField(
            label: 'CYL', isHide: true, isLeft: isLeft, orderItem: orderItem),
        _buildTextField(
            label: 'AXIS', isHide: true, isLeft: isLeft, orderItem: orderItem),
      ],
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
              ...
              child: Text(isLeft
                  ? (label == 'SPH'
                      ? orderItem.eyePrescriptionData!.rightDSph ?? ''
                      : label == 'CYL'
                          ? orderItem.eyePrescriptionData!.rightDCyl ?? ''
                          : orderItem.eyePrescriptionData!.rightDAxis ?? '')
                  : (label == 'SPH'
                      ? orderItem.eyePrescriptionData!.leftDSph ?? ''
                      : label == 'CYL'
                          ? orderItem.eyePrescriptionData!.leftDCyl ?? ''
                          : orderItem.eyePrescriptionData!.leftDAxis ?? ''))),
          Padding(
              padding: const EdgeInsets.symmetric(horizontal: 8),
              child: isHide == true
                  ? Text(" ")
                  : Text(isLeft
                      ? orderItem.eyePrescriptionData!.leftNSph ?? ''
                      : orderItem.eyePrescriptionData!.rightNSph ?? '')),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8),
            child: isHide == true
                ? Text(" ")
                : Text(isLeft
                    ? orderItem.eyePrescriptionData!.leftAddSph ?? ''
                    : orderItem.eyePrescriptionData!.rightAddSph ?? ''),
          ),
        ],
      ),
    );

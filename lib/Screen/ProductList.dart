...
import 'package:mahireenopticals/Helper/SimBtn.dart';
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(model.shortDescription.toString(),maxLines: 1,overflow: TextOverflow.ellipsis,style: TextStyle(color: Colors.grey),),
            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  Visibility(
                    visible: (off != 0 || off != 0.0 || off != 0.00),
                    child: Align(
              ...
              Padding(
                padding: const EdgeInsetsDirectional.only(start: 10.0, top: 10,end: 10),
                child: Row(
              ...
              Padding( padding: const EdgeInsetsDirectional.only(start: 10.0,end: 10),
              child: Text(model.shortDescription.toString(),maxLines: 2,overflow: TextOverflow.ellipsis,),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Visibility(
                      visible: (model.rating! == "0" || model.rating! == "0.0"),
                      child: Row(
                        children: [
                          RatingBarIndicator(
                            rating: double.parse(model.rating!),

...
import 'package:mahireenopticals/Screen/SellerList.dart';
import 'package:mahireenopticals/Screen/Seller_Details.dart';
import 'package:mahireenopticals/Screen/SubCategory.dart';
   ...
   // Map map = Map();
    ...
    apiBaseHelper.postAPICall(getSliderApi,{}).then((val) {
      ...
      if (!error) {
        ...
        homeSliderList =
            (data as List).map((data) => new Model.fromSlider(data)).toList();
        print("Length Slider: ${homeSliderList.length}");

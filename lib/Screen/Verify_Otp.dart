...
// import 'package:mahireenopticals/Screen/Details.dart';
// import 'package:mahireenopticals/Screen/Set_Password.dart';
...
print(data);
  ...
  Future<void> verifyotpforLogin() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${baseUrl}otp_verify'));
    request.fields.addAll({
      'mobile': widget.mobileNumber.toString(),
      'otp': otp.toString(),
    });
